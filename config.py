...
CHANNELS = {
    ...
    "erp": {
        ...
        "name": "🏢 ERP & Accounting",
        "keywords": [
            "erp developer", "erp consultant", "erp",
            "odoo developer", "odoo", "odoo engineer",
            "sap developer", "sap consultant", "sap engineer", "sap",
            "salesforce developer", "salesforce",
            "dynamics developer", "dynamics 365",
            "oracle developer", "oracle ebs", "oracle apps",
